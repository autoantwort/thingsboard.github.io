...
![image](https://img.tbqa.cloud/trendz/state-simple-view.png)
...
![image](https://img.tbqa.cloud/trendz/state-simple-config-drop.png)

![image](https://img.tbqa.cloud/trendz/state-simple-config.png)

Our view ready and now we know how much time(in percent) machines spent in different states.

<div class="image-block">
    <div class="image-wrapper">
       <video poster="https://img.tbqa.cloud/trendz/state-simple-view.png" autoplay="" loop="" preload="auto" muted="" style="width: 750px">
...
![image](https://img.tbqa.cloud/trendz/state-multiple-view.png)
...
<div class="image-block">
    <div class="image-wrapper">
       <video poster="https://img.tbqa.cloud/trendz/state-multiple-view.png" autoplay="" loop="" preload="auto" muted="" style="width: 750px">
