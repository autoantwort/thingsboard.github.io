...
trendz-prediction-overview-simple:
  0:
    image: https://img.tbqa.cloud/trendz/prediction-simple-initial.png
    title: 'Configure prediction for energy consumption on line chart'
  1:
    image: https://img.tbqa.cloud/trendz/prediction-simple-cfg.png
    title: 'Select prediction model and forecast horizon'

trendz-prediction-overview-bar-consumption:
 0:
  image: https://img.tbqa.cloud/trendz/prediction-sum-view.png
  title: 'Resource usage foreacast for the next year'
 1:
  image: https://img.tbqa.cloud/trendz/prediction-sum-cfg1.png
  title: 'Select prediction model and forecast horizon'
...
![image](https://img.tbqa.cloud/trendz/prediction-simple-view.png)
...
<div class="image-block">
    <div class="image-wrapper">
       <video poster="https://img.tbqa.cloud/trendz/prediction-simple-view.png" autoplay="" loop="" preload="auto" muted="" style="width: 750px">
...
<div class="image-block">
    <div class="image-wrapper">
       <video poster="https://img.tbqa.cloud/trendz/prediction-sum-view.png" autoplay="" loop="" preload="auto" muted="" style="width: 750px">
...
![image](https://img.tbqa.cloud/trendz/prediction-validation.png)
