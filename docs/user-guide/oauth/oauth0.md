...
![image](https://img.tbqa.cloud/user-guide/oauth-2-support/oauth0/Application-to-create.png)
...
![image](https://img.tbqa.cloud/user-guide/oauth-2-support/oauth0/Application-creation.png)

Afters, you need to specify the technology being used. Please, specify the **Java Spring Security**.  

![image](https://img.tbqa.cloud/user-guide/oauth-2-support/oauth0/Application-creation-specify-type.png)
...
![image](https://img.tbqa.cloud/user-guide/oauth-2-support/oauth0/Application-Details-1.png)
...
![image](https://img.tbqa.cloud/user-guide/oauth-2-support/oauth0/Application-Details-2.png)
...
![image](https://img.tbqa.cloud/user-guide/oauth-2-support/oauth0/Application-Details-3.png)
