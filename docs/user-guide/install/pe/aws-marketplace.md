...
![image](https://img.tbqa.cloud/user-guide/install/aws-marketplace-pe/tb-pe-mk-launch-security.png)

Populate necessary Security Group name and details and save new group

![image](https://img.tbqa.cloud/user-guide/install/aws-marketplace-pe/tb-pe-mk-new-security-group.png)
...
![image](https://img.tbqa.cloud/user-guide/install/aws-marketplace-pe/tb-pe-mk-launch-launch.png)
...
![image](https://img.tbqa.cloud/user-guide/install/aws-marketplace-pe/tb-pe-mk-launch-complete.png)
...
![image](https://img.tbqa.cloud/user-guide/install/aws-marketplace-pe/tb-pe-mk-ec2-console.png)
