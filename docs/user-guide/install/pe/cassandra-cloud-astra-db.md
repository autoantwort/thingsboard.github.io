...
![Register or sign in to Astra DB](https://img.tbqa.cloud/user-guide/install/datastax-astra-db/register_or_sign_in_astra_db.png)

![Login success. Main page with no database](https://img.tbqa.cloud/user-guide/install/datastax-astra-db/astra_main_page.png)
...
![Click create database from the main page](https://img.tbqa.cloud/user-guide/install/datastax-astra-db/create_database_navigate_from_main_page.png)

![Fill database and keyspace name, choose location and click create](https://img.tbqa.cloud/user-guide/install/datastax-astra-db/create_database.png)

![Database Created!](https://img.tbqa.cloud/user-guide/install/datastax-astra-db/create_database_success.png)

The database list will look like on the picture below:

![Dashboard with new database created](https://img.tbqa.cloud/user-guide/install/datastax-astra-db/dashboard_with_fresh_database.png)
...
![Create a token menu](https://img.tbqa.cloud/user-guide/install/datastax-astra-db/generate_a_token_menu.png)

![Generate database administrator token](https://img.tbqa.cloud/user-guide/install/datastax-astra-db/generate_database_administrator_token.png)

![Your token has been generated](https://img.tbqa.cloud/user-guide/install/datastax-astra-db/generate_token_success.png)
...
![Secure cloud bundle download page](https://img.tbqa.cloud/user-guide/install/datastax-astra-db/cloud_bundle_download_page.png)

![Choose region to download secure cloud bundle](https://img.tbqa.cloud/user-guide/install/datastax-astra-db/cloud_bundle_choose_region.png)

![Cloud bundle downloaded](https://img.tbqa.cloud/user-guide/install/datastax-astra-db/cloud_bundle_downloaded.png)
