...
![image](https://img.tbqa.cloud/user-guide/install/azure-marketplace/get-it-now.png)

- Review and accept terms of use and privacy policy. Click the "Continue" button.

![image](https://img.tbqa.cloud/user-guide/install/azure-marketplace/continue.png)

- You will be redirected to Azure Portal. Click the "Create" button to deploy your instance.

![image](https://img.tbqa.cloud/user-guide/install/azure-marketplace/create.png)
...
![image](https://img.tbqa.cloud/user-guide/install/azure-marketplace/config-basics.png)
...
![image](https://img.tbqa.cloud/user-guide/install/azure-marketplace/config-disks.png)
...
![image](https://img.tbqa.cloud/user-guide/install/azure-marketplace/config-networking.png)
...
![image](https://img.tbqa.cloud/user-guide/install/azure-marketplace/config-review.png)

- Once deployment is started it may take up to 30 minutes (but usually less then 5 minutes) to complete;

![image](https://img.tbqa.cloud/user-guide/install/azure-marketplace/launch-progress.png)

- Once your deployment is complete, click the "Go to resource" button.

![image](https://img.tbqa.cloud/user-guide/install/azure-marketplace/launch-completed.png)
...
![image](https://img.tbqa.cloud/user-guide/install/azure-marketplace/resource-overview.png)
