...
smsProviderSettings:
    0:
        image: https://img.tbqa.cloud/user-guide/ui/sms/sms-provider-settings-step-2-ce.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/ui/sms/sms-provider-settings-step-3-ce.png
        title: 'If you have chosen AWS SNS, populate AWS Access Key ID and Secret access key. Click "Save" button;'
    2:
        image: https://img.tbqa.cloud/user-guide/ui/sms/sms-provider-settings-step-4-ce.png
    ...
    3:
        image: https://img.tbqa.cloud/user-guide/ui/sms/sms-provider-settings-step-5-ce.png
