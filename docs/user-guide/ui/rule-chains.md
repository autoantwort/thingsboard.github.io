...
create-rule-chain:
    0:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/create-rule-chain-1-ce.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/create-rule-chain-2-ce.png
        title: 'Specify a name for the rule chain. If necessary, enable "Debug mode". Click "Add";'
    2:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/create-rule-chain-3-ce.png
        title: 'The new rule chain is created. To open rule chain click on it.'

export-rule-chain:
    0:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/export-rule-chain-1-ce.png
...
import-rule-chain:
    0:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/import-rule-chain-1-ce.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/import-rule-chain-2-ce.png
        title: 'The toolbar import popup window will appear. Upload a JSON file and click on the "Import" button;'
    2:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/import-rule-chain-3-ce.png
    ...
    3:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/import-rule-chain-4-ce.png
        title: 'Rule chain is imported.'

edit-rule-chain:
    0:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/edit-rule-chain-1-ce.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/edit-rule-chain-2-ce.png
        title: 'The rule chain details window will open. Click on the "pencil" icon to enter edit mode;'
    2:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/edit-rule-chain-3-ce.png
        title: 'Edit name for this rule chain and enable debug mode. After that, click on the "Apply changes" button;'
    3:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/edit-rule-chain-4-ce.png
        title: 'You changed rule chain name and enable debug mode.'

make-rule-chain-as-root:
    0:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/make-rule-chain-root-1-ce.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/make-rule-chain-root-2-ce.png
        title: 'Please confirm your actions in the dialog box;'
    2:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/make-rule-chain-root-3-ce.png
        title: 'The selected rule chain has now become the root.'

delete-rule-chain-1:
    0:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/delete-rule-chain-1-ce.png
        title: 'Click a trash icon can opposite the rule chains`s name you want to delete;'
    1:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/delete-rule-chain-2-ce.png
        title: 'Confirm deleting the rule chain in the dialog box.'

delete-rule-chain-2:
    0:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/delete-rule-chain-3-ce.png
        title: 'Click on the "Rule chain details" button located on the particular rule chain row;'
    1:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/delete-rule-chain-4-ce.png
        title: 'In the rule chain details, click on the "Delete rule chain" button;'
    2:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/delete-rule-chain-5-ce.png
        title: 'Confirm deleting the rule chain in the dialog box.'

delete-rule-chain-3:
    0:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/delete-rule-chain-6-ce.png
        title: 'Mark one or multiple rule chains you want to delete. Click on the trash bin icon in the top right corner;'
    1:
        image: https://img.tbqa.cloud/user-guide/ui/rule-chains/delete-rule-chain-7-ce.png
