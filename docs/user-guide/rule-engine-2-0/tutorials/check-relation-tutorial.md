...
## Adding the devices and creating the relation between them
  ...
  The following screenshots show how to do this:
   ...
   ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/smoke-sensor.png) ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/fire-alarm-system.png) <br>
   ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/add-relation.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/fire-alarm-chain.png)

 - **Root Rule Chain:**

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/root-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/add-fire-alarm-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/check-relation.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/change-originator.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/transformation-node.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/rpc-call-request.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/alarm-filter.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/clear-alarm.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/create-alarm.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/add-alarm-chain.png)

The following screenshot shows how the final **Root Rule Chain** should look like:

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/view-chain.png)
...
<br>
  ...
  ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/smoke-telemetry.png)![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/fire-alarm-telemetry.png)
