...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/add-thermometer.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/temperature-delta-validation-chain.png)

 - **Root Rule Chain:**

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/root-rule-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/add-temperature-delta-validation-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/latest-five-minute-old-record.png)
...
###### Node B: **Script Transformation**
 ...
 ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/calculate-delta.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/save-timeseries.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/validate-delta.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/create-alarm.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/clear-alarm.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/add-rule-chain-node.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/access-token.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/debug-mode-create-alarm.png)<br>
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/first-post-telemetry.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/second-post-telemetry.png)

Alarm should be created:

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/delta-validation/alarm-created.png)
