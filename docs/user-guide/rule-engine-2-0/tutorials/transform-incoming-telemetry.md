...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/transformation/rule-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/transformation/node-config.png)

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/transformation/test-function.png)
