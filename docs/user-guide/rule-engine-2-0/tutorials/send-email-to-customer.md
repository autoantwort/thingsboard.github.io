...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email/create-customer.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email/manage-devices.png)
<br>

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email/assign-device.png)
<br>
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email/customer-email.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email/add-address.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email/send-email-to-customer-chain.png)

 - **Root Rule Chain:**

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email/root-rule-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email/get-customer-email.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email/get-device-address.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email/modify-to-email.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email v2/copy-token.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email/mail-received.png)
