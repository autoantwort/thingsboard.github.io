...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/add-device.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/add-attribute.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/initial-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/chain.png)
...
#### Creating a new Rule Chain (**Tutorial of Inactivity Event**)
 ...
 - Enter the Name field as **Tutorial of Inactivity Event**, then click the **ADD** button.
  ...
  ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/add-chain.png)  ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/root-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/message-type-switch.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/save-ts.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/save-attributes.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/create-alarm.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/clear-alarm.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/access-token.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/telemetry.png)

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/inactivity alarms/created-alarm.png)
