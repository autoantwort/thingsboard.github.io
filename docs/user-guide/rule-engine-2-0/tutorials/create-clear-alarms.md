...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/add-device.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/create-clear-alarm-chain.png)

 - **Root Rule Chain:**

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/root-rule-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/add-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/filter-alarm.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/create-alarm.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/clear-alarm.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/check relation/initial-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/add-chain-node.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/debug-mode-clear-alarm.png)<br>
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/debug-mode-create-alarm.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/alarm-created.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/alarm-updated.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms v2/alarm-cleared.png)
