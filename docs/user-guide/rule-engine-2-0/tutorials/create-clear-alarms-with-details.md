...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms/create-clear-alarm-chain.png)

  - **Root Rule Chain:**

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms/root-rule-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms/create-alarm.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms/clear-alarm.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms/add-dashboard.png)

Press **Edit** dashboard and **add alias** that will be resolved to all devices with type **Thermostat**:

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms/add-alias.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms/alarm-widget-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms/copy-access-token.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms/alarm-created.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms/alarm-updated.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/alarms/alarm-cleared.png)
