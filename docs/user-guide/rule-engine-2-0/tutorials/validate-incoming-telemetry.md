...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/validation/rule-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/validation/node-config.png)

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/validation/test-function.png)
