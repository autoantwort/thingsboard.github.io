...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/create-chain.png) ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/root-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/message-type-switch.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/save-ts.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/get-related.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/change-originator.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/rpc-message.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/check-validity.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/request.png)
...
- Copy the **Wind Direction Sensor** device access token and the **Rotating System** device access token, then paste them in the script.  <br>
 ...
 ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/wind-token.png) ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/rs-token.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/dashboard.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/rpc-request/aliases.png)
