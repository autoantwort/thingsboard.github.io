...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email v2/send-email-chain.png)

 - **Root Rule Chain:**

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email v2/root-rule-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email v2/transform-script.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email v2/to-email.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email v2/send-email.png)
...
- In the scope of this tutorial we will use **SendGrid** as SMTP provider and Thingsboard will send email using this provider. You can sign-up for trial using this [link](https://app.sendgrid.com/signup).
  ...
  ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email v2/sendgrid-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email v2/test-email.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/email v2/mail-received.png)
