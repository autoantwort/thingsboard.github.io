...
![image](https://img.tbqa.cloud/samples/nodemcu/temperature/dashboard.png)
...
## List of hardware and pinouts
 ...
 ![image](https://img.tbqa.cloud/samples/nodemcu/temperature/dht-pinout.jpg)
 
 - 3 female-to-female jumper wires

## Wiring schema

 ![image](https://img.tbqa.cloud/samples/nodemcu/temperature/schema.png)
