...
### Prerequisites
 ...
 <img src="https://img.tbqa.cloud/samples/tektelic/setup_scheme.png" width="800" alt="setup scheme">
...
##### Step 1.1 Add a gateway
 ...
 <img data-gifffer="https://img.tbqa.cloud/samples/tektelic/add_a_gateway.gif" width="1000" alt="add a gateway">
 ...
 <img src="https://img.tbqa.cloud/samples/tektelic/gateway_statistics.png" width="800" alt="gateway statistics">
...
Smart Room Sensor has a sticker with QR code with data required by Network Server.
 ...
 <img src="https://img.tbqa.cloud/samples/tektelic/smart_room_sensor_QR.png"width="200" alt="smart room sensor QR">

 QR code contains Device EUI and Application EUI values.

 <img src="https://img.tbqa.cloud/samples/tektelic/QR_scan_result.png" width="200" alt="QR scan result">
 ...
 <img data-gifffer="https://img.tbqa.cloud/samples/tektelic/add_a_sensor.gif" width="1000" alt="add a sensor">
 ...
 <img src="https://img.tbqa.cloud/samples/tektelic/sensor_packets.png" width="800" alt="sensor packets">
 ...
 <img src="https://img.tbqa.cloud/samples/tektelic/sensor_activation_tab.png" width="800" alt="sensor activation tab">
 ...
 *Is gateway* checkbox has to be set to make a device using [MQTT Gateway API](/docs/reference/gateway-mqtt-api/).
 ...
 <img src="https://img.tbqa.cloud/samples/tektelic/tb_gateway.png" width="800" alt="gateway">
...
##### Step 2.2 Add an integration in Network Server
 ...
 <img src="https://img.tbqa.cloud/samples/tektelic/ns_integration.png" width="800" alt="ns integration">
 ...
 **Only after a new uplink** Network Server, through [MQTT Gateway API](/docs/reference/gateway-mqtt-api/), will create new devices in ThingsBoard.
 ...
 <img src="https://img.tbqa.cloud/samples/tektelic/tb_from_relations.png" width="1000" alt="from relations">
 <br>
 ...
 <img data-gifffer="https://img.tbqa.cloud/samples/tektelic/import_dashboard.gif" width="1000" alt="import dashboard">
