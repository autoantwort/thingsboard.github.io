...
<br><br>
![image](https://img.tbqa.cloud/samples/nettrartu+/nettrartu+.png)   ![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/dashboard.png)
...
![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/connection_diagram.png)
...
<br><br>
![image](https://img.tbqa.cloud/samples/nettrartu+/device.png)
<br><br>
...
<br><br>
 ![image](https://img.tbqa.cloud/samples/nettrartu+/credentials.png)
...
## Connect RTU+ to PC
 ...
 - Open the RTU+ Configuration Interface. 
   ...
   ![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/serial_connection.png)

   Once you are connected you should see this icon :

   ![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/connected.png)
...
4. Save clicking *"Aplicar cambios"*.
   ...
   ![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/ethernet_conf.png)
...
5. Click *"Aplicar cambios"* to save.
   ...
   ![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/mqtt_conf.png)

   You should see in *"Estado"*: *"Conectado"* (MQTT status: Connected)
   (It could take some minutes the first time)

   ![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/status.png)
...
2. Click *"Configurar Hora"*.
   ...
   ![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/configure_time.png)
...
2. Here we have two possibles configurations, depending on your temperature sensor.
   ...
   ![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/current_input.png)
   ...
   ![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/voltage_input.png)
...
2. Import the script clicking *"Cargar"*. If you want to make your own script, you can see the [Nettra C](https://nettra.tech) user manual.
   ...
   ![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/import_script.png)

3. Compile and save the script in the RTU+ by clicking *"Compilar y Aplicar"*.

   ![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/script_running.png)
...
![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/telemetry_table.png)
...
![image](https://img.tbqa.cloud/samples/nettrartu+/rtu_temp_sensor/dashboard.png)
