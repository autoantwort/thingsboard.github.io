...
## Wiring schema
 ...
 ![image](https://img.tbqa.cloud/samples/raspberry/gpio-android-things/raspberry-gpio-leds.png)
...
Below is the screenshot of the "Raspberry PI GPIO Demo Dashboard".  
 ...
 ![image](https://img.tbqa.cloud/samples/raspberry/gpio/dashboard.png)
