...
![image](https://img.tbqa.cloud/samples/abeeway/actility_dashboard_example.png)
...
<details>
    ...
    <ul>
        ...
        <details>
            ...
            <img src="https://img.tbqa.cloud/samples/abeeway/actility_device.png" alt="Actility device example">
        </details>
    </ul>
</details>
...
<details>
    ...
    <img src="https://img.tbqa.cloud/samples/abeeway/add_uplink_decoder.png" alt="Add uplink decoder dialog">
</details>
...
<details>
    ...
    <img src="https://img.tbqa.cloud/samples/abeeway/add_downlink_decoder.png" alt="Add downlink decoder dialog">
</details>
...
After creating the Uplink Converter to the Decoder section, you need to update the Decoder code to [the following code](https://img.tbqa.cloud/samples/abeeway/upLinkDecoder.txt).
...
<details>
   ...
   <ul>
        <details>
            ...
            <img src="https://img.tbqa.cloud/samples/abeeway/uplink_decoder.png" alt="Uplink decoder properties screen">
        </details>
        <details>
            <summary>
            ...
            <ul>
                ...
                <details>
                 ...
                 <img src="https://img.tbqa.cloud/samples/abeeway/uplink_decoder_input.png" alt="Uplink decoder input dialog">
                </details>
            </ul>
        </details>
        <details>
            ...
            <ul>
                ...
                <details>
                  ...
                  <img src="https://img.tbqa.cloud/samples/abeeway/uplink_decoder_output.png" alt="Uplink decoder output dialog">
                </details>
                <details>
                    <summary>
...
<details>
    ...
    <img src="https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/import_new_converter.png" alt="Import new converter screen">
</details>
...
After creating the Downlink Converter to the Decoder section, you need to update the Decoder code to [the following code](https://img.tbqa.cloud/samples/abeeway/downlinkDecoder.txt). <br>
...
Open Downlink Converter, editor mode, click "test decoder function" and replace the default code with a new code:
   ...
   <ul>
        <details>
            ...
            <img src="https://img.tbqa.cloud/samples/abeeway/downlink_decoder.png" alt="Downlink decoder properties screen">
        </details>
        <details>
            <summary>
...
<details>
    ...
    <img src="https://img.tbqa.cloud/samples/abeeway/create_integration.png" alt="Create integration dialog">
</details>
...
<details>
    ...
    <img src="https://img.tbqa.cloud/samples/abeeway/actility_application.png" alt="Adding credentials in Actility application">
</details>
...
<details>
   ...
   <img src="https://img.tbqa.cloud/samples/abeeway/after_integr_mesag.png" alt="After integr mesage screen">
</details>
...
<details>
   ...
   <img src="https://img.tbqa.cloud/samples/abeeway/after_integr_dev.png" alt="After integr dev screen">
</details>
...
<details>
   ...
   <img src="https://img.tbqa.cloud/samples/abeeway/actility_dashboard_example.png" alt="Actility dashboard example screen">
</details>

[Example:  Dashboard in json format](https://img.tbqa.cloud/samples/abeeway/actility_dashboard.json)
...
<details>
   ...
   <img src="https://img.tbqa.cloud/samples/abeeway/dashboard_create_01.png" alt="Dashboard creating step 01 dialog">
</details>
<ol>
    ...
    <details>
        ...
        <img src="https://img.tbqa.cloud/samples/abeeway/alias_create.png" alt="Alias creating dialog">
    </details>
    ...
    <details>
        ...
        <img src="https://img.tbqa.cloud/samples/abeeway/alias_create_entityFromDashboard.png" alt="Alias create entity From Dashboard dialog">
    </details>
</ol>
...
<ol>
    ...
    <ul>
        ...
        <details>
             ...
             <img src="https://img.tbqa.cloud/samples/abeeway/widget_create_cards.png" alt="Widget create cards screen">
         </details>
        <li> Action: action sources: on row click, Name: ${entityName}, type: Update_current_dashboard_state, Set_entity_from_widget </li>
         <details>
              ...
              <img src="https://img.tbqa.cloud/samples/abeeway/widget_create_cards_action.png" alt="Widget create cards action dialog">
          </details>
    </ul>
    ...
    <ul>
        ...
        <details>
           ...
           <img src="https://img.tbqa.cloud/samples/abeeway/widget_create_charts_timeseriesFloat.png" alt="Widget create charts timeseries Float screen">
        </details>
        ...
        <details>
            ...
            <img src="https://img.tbqa.cloud/samples/abeeway/widget_create_charts.png" alt="Widget create charts screen">
        </details>
        <details>
           <summary>
               <font color="#006400"><i><b>Screenshot of adding datasource to widget number 2 (part 2)</b></i></font> (<b>click to open expanded view</b>)
           </summary>
           <img src="https://img.tbqa.cloud/samples/abeeway/widget_create_charts_entityLabel.png" alt="Widget create charts entity Label dialog">
        </details>  ![image](https://img.tbqa.cloud/samples/abeeway/Actility Dashboard_Example.png)
    </ul>
    ...
    <ul>
        ...
        <details>
           ...
           <img src="https://img.tbqa.cloud/samples/abeeway/widget_create_difital_guages.png" alt="Widget create difital guages screen">
        </details>
        <li>Data_Source: type: Entity, parameters: DigEntityFrom, key:temperature, label: temperature</li>
         <details>
            ...
            <img src="https://img.tbqa.cloud/samples/abeeway/widget_create_difital.png" alt="Widget create difital scren">
         </details>
    </ul>
    ...
    <ul>
        ...
        <details>
           ...
           <img src="https://img.tbqa.cloud/samples/abeeway/widget_create_cards_Timeseries.png" alt="Widget create cards Timeseries screen">
        </details>
        ...
        <details>
         ...
         <img src="https://img.tbqa.cloud/samples/abeeway/widget_create_cards_with_value.png" alt="Widget create cards with value screen">
        </details>
    </ul>
    ...
    <ul>
        ...
        <details>
           ...
           <img src="https://img.tbqa.cloud/samples/abeeway/widget_create_input.png" alt="Widget create input screen">
        </details>
        <li>Data_Source: type: Entity, parameters: DigEntityFrom</li>
            <ul>
        ...
        <details>
         ...
         <img src="https://img.tbqa.cloud/samples/abeeway/widget_create_input_with_value.png" alt="Widget create input with value dialog">
        </details>
    </ul>
</ol>
...
<details>
    ...
    <img src="https://img.tbqa.cloud/samples/abeeway/integration_latest_telemetry.png" alt="Integration latest telemetry screen">
</details>
<details>
    <summary>
    ...
    <img src="https://img.tbqa.cloud/samples/abeeway/integration_events.png" alt="Integration events dialog">
</details>
...
<details>
 ...
 <img src="https://img.tbqa.cloud/samples/abeeway/rule_chain.png" alt="Rule chain example screen">
</details> <br>
...
<ul>
    ...
    <details>
     ...
     <img src="https://img.tbqa.cloud/samples/abeeway/create_incrichment_originator_fields.png" alt="Create encrichment originator fields screen">
    </details>
            ...
            <ul>
                <li>add: Action: "integration downlink": name: Actility_DownLink, integration: Test_ThigPark</li>
                    <details>
                     ...
                     <img src="https://img.tbqa.cloud/samples/abeeway/create_action _integration_downlink.png" alt="Create action integration downlink screen">
                    </details>
            </ul>
...
<details>
    <summary>
     ...
     <ul>
        ...
        [JSON: Create request "Position on demand"](https://img.tbqa.cloud/samples/abeeway/payloadHex_0102.json)
        <details>
            <summary>
...
<details>
    ...
    <ul>
        ...
        <details>
             ...
             <img src="https://img.tbqa.cloud/samples/abeeway/sent_message.png" alt="Sent message screen">
        </details>
        <details>
            <summary>
        ...
        <details>
          ...
          <img src="https://img.tbqa.cloud/samples/abeeway/receiving_message_actility.png" alt="Receiving message actility screen">
         </details>
        <details>
          <summary>
          ...
          <img src="https://img.tbqa.cloud/samples/abeeway/receiving_actility_from_dev.png" alt="Receiving actility from dev screen">
         </details>
        <details>
          <summary>
          ...
          <img src="https://img.tbqa.cloud/samples/abeeway/receiving_confirmation_singboard.png" alt="Receiving confirmation thingboard dialog">
         </details>
        <details>
          <summary>
          ...
          <img src="https://img.tbqa.cloud/samples/abeeway/decoding_device_response.png" alt="Decoding device response dialog">
         </details>
    </ul>
