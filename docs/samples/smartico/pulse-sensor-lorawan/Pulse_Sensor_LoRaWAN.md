...
![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/dashboard.png)
...
![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/Lorawan1.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/Lorawan2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/uplink_import.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/integration.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/verify1.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/verify2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/asset1.PNG)

![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/asset2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/alarms1.PNG)

Then configure Root Rule chain. You should add in Root Rule chain Alarms Pulse Sensor as it shown on the figure.

![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/alarms2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/importDashboard.PNG)

When importing a dashboard, it will be necessary to create an alias, as shown in the figure.

![image](https://img.tbqa.cloud/samples/smartico/pulse-sensor-lorawan/alias.PNG)
