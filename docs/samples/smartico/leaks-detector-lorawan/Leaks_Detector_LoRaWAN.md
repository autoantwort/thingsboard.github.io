...
![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/mainDash.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/Lora1.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/Lora2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/uplink.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/Integration.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/verifying.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/verifying2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/addAsset.PNG)

![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/addRelation.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/alarm1.PNG)

Then configure Root Rule chain. You should add in Root Rule chain Alarms Leaks Detector as it shown on the figure.

![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/alarm2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/dashboard.PNG)

When importing a dashboard, it will be necessary to create an alias, as shown in the figure.

![image](https://img.tbqa.cloud/samples/smartico/leaks-detector-lorawan/alias.PNG)
