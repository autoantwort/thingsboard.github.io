...
![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/MainDash.png)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/Lora1.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/Lora2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/converter.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/integration.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/Verifying.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/VerifyingUplink.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/asset.PNG)

![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/asset2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/alarm1.PNG)

Then configure Root Rule chain. You should add in Root Rule chain Alarms Gas Valve as it shown on the figure.

![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/alarm2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/dashboard1.PNG)

When importing a dashboard, it will be necessary to create an alias, as shown in the figure.

![image](https://img.tbqa.cloud/samples/smartico/gas-valve-lorawan/dashboard2.PNG)
