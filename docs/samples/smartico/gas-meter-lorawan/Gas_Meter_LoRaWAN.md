...
![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/MainDashboard.png)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/lora1.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/Lora2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/convert.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/integration.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/verify.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/verify1.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/asset1.PNG)

![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/asset2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/alarm1.PNG)

Then configure Root Rule chain. You should add in Root Rule chain Alarms Gas Meter as it shown on the figure.

![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/alarm2.PNG)
...
![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/dashboard1.PNG)

When importing a dashboard, it will be necessary to create an alias, as shown in the figure.

![image](https://img.tbqa.cloud/samples/smartico/gas-meter-lorawan/dashboard2.PNG)
