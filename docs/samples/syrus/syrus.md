...
![image](https://img.tbqa.cloud/samples/syrus/copy_token.png)
...
![image](https://img.tbqa.cloud/samples/syrus/update_device.png)
...
![image](https://img.tbqa.cloud/samples/syrus/js_latest.png)
...
![image](https://img.tbqa.cloud/samples/syrus/new_instance.png)

Name your instance and select the &quot;Create Instance&quot; button:

![image](https://img.tbqa.cloud/samples/syrus/name_instance.png)


Now you have your instance created:

![image](https://img.tbqa.cloud/samples/syrus/instance_created.png)
...
![image](https://img.tbqa.cloud/samples/syrus/configuration_files.png)
...
![image](https://img.tbqa.cloud/samples/syrus/example.png)
...
![image](https://img.tbqa.cloud/samples/syrus/select_instance.png)

Go to Data Folder Tab:

![image](https://img.tbqa.cloud/samples/syrus/data_tab.png)

Select Upload File:

![image](https://img.tbqa.cloud/samples/syrus/upload_file.png)

And search in your local disk the previous configurations files created, and upload it one by one

![image](https://img.tbqa.cloud/samples/syrus/upload_config.png)
...
![image](https://img.tbqa.cloud/samples/syrus/select_configuration.png)

### 5. Start your instance

Finally, go back to the Information tab and click the Start button:

![image](https://img.tbqa.cloud/samples/syrus/information_tab.png)
...
![image](https://img.tbqa.cloud/samples/syrus/latest_telemetry.png)

Now you can use Thingsboard&#39;s tools to design your own dashboard with Syrus 4G data:

![image](https://img.tbqa.cloud/samples/syrus/dashboard.png)
