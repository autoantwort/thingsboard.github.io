...
![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/dashboard.png)
...
## List of hardware
 ...
 - Arduino UNO
   ...
   ![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/arduino-uno-pinout.png)

 - [HTU21D sensor](https://www.sparkfun.com/products/13763)

   ![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/htu21d.jpg)

 - [SIM808 GSM shield](https://www.elecrow.com/wiki/index.php?title=SIM808_GPRS/GSM%2BGPS_Shield_v1.1)

   ![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/sim808_shield.jpg)
...
Double-check that your wiring follows schematics below:
   ...
   ![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/arduino-uno-sim808-htu21d.png)

The complete setup will look like that:

   ![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/arduino-uno-sim808-htu21d-photo.png)
...
![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/device.png)

Once device created, open its details and click "Manage credentials".

Copy auto-generated access token from the "Access token" field. Please save this device token. It will be referred to later as **$ACCESS_TOKEN**.

![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/credentials.png)
...
1. Find and install **ThingsBoard Arduino SDK** and **PubSubClient by Nick O'Leary** libraries.
   ...
   ![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/install-tb-arduino.png)
...
1. Install **ArduinoJSON** library **v6.9.1** or higher. <span style="color:red">Avoid installing beta releases of the ArduinoJson library</span>.
   ...
   ![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/do-not-use-beta-version-arduinojson.png)

1. Install **ArduinoHttpClient** library.

   ![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/install-http-arduino.png)
...
![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/install-htu21d.png)

### Step 4. Install SIM808 driver

The SIM808 is support by the TinyGSM driver, which can be installed as described below.

![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/install-tinygsm.png)
...
![image](https://img.tbqa.cloud/samples/arduino/sim808-htu21d/telemetry.png)
