...
![image](https://img.tbqa.cloud/samples/arduino/temperature/dashboard.png)
...
## List of hardware and pinouts
 ...
 - Arduino UNO
  ...
  ![image](https://img.tbqa.cloud/samples/arduino/temperature/arduino-uno-pinout.png)
...
![image](https://img.tbqa.cloud/samples/arduino/temperature/schema.png)
...
![image](https://img.tbqa.cloud/samples/arduino/temperature/device.png)

Once device created, open its details and click "Manage credentials".

Copy auto-generated access token from the "Access token" field. Please save this device token. It will be referred to later as **$ACCESS_TOKEN**.

![image](https://img.tbqa.cloud/samples/arduino/temperature/credentials.png)
...
![image](https://img.tbqa.cloud/samples/arduino/temperature/attributes.png)
