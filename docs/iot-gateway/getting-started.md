...
{% assign createNewGatewayDevice = '
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/gateway-getting-started-1-ce.png,
        title: Go to "**Dashboards**" tab and open "**ThingsBoard IoT Gateways**" dashboard.
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/gateway-getting-started-2-ce.png,
...
{% assign remoteCreateGatewayDocker = '
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/gateway-getting-started-3-ce.png,
        title: On the gateway dashboard, click on **"Launch command"** button in the top right corner.
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/gateway-getting-started-4-ce.png,
...
![](https://img.tbqa.cloud/gateway/dashboard/launch-gateway-docker.png)
...
{% assign enableRemoteLogging = '
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/general-configuration-1-ce.png,
        title: On the gateway dashboard, click on **"General configuration"** button on the right panel.
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/general-configuration-2-ce.png,
...
{% assign checkDeviceData = '
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/review-gateway-statistics-1-ce.png,
    ...
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/review-gateway-statistics-2-ce.png,
...
{% assign importWidgetsBundle = '
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/wl-import-bundle-gateway-1-ce.png,
    ...
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/wl-import-bundle-gateway-2-ce.png,
    ...
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/wl-import-bundle-gateway-3-ce.png,
...
{% assign importGatewayDashboard = '
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/import-dashboard-gateway-1-ce.png,
    ...
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/import-dashboard-gateway-2-ce.png,
        title: In the import dashboard window, upload the downloaded gateway dashboard JSON file and click "**Import**".
    ===
        image: https://img.tbqa.cloud/gateway/dashboard/import-dashboard-gateway-3-ce.png,
