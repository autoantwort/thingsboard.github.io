...
Check data in your ThingsBoard instance, that you have been configured in the [general configuration guide](/docs/iot-gateway/configuration/).  
    ...
    <br>    
    ![](https://img.tbqa.cloud/gateway/temp-hum-sensor.png)
<br><br>
...
<br>
![](https://img.tbqa.cloud/gateway/attribute-on-ble-device.png)
...
![](https://img.tbqa.cloud/gateway/changed-name-ble-tb-gateway.png)
