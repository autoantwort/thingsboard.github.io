...
![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-list.png)
...
![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard.png)
...
![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-cards.png)
...
![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-devices.png)

- **Alarms** is a standard alarm widget where you will receive all alarms related to selected gateway;

![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-alarms.png)
...
- **Navigation Panel** is a navigation panel on which all other dashboards for configuring, managing and monitoring the gateway are located, namely:
   ...
   ![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-launch-command.png)

   - [General configuration](#general-configuration) - dashboard with general gateway settings;
  
   [![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-gen-conf-button.png)](#general-configuration)

   - [Connectors configuration](#connector-configuration) - dashboard with management and configuration of connectors;
  
   [![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-connectors-conf-button.png)](#connector-configuration)
   ...
   [![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-logs-button.png)](#logs)

   - [Statistics](#statistics) - a dashboard with general and custom statistics of the gateway;

   [![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-statistics-button.png)](#statistics)
   ...
   [![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-remote-shell-button.png)](#remote-shell)

   - [RPC](#rpc) - Gateway RPC sending dashboard.

   [![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-rpc-button.png)](#rpc)
...
![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-connectors.png)
...
![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-logs.png)
...
![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-statistics.png)
...
![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-shell.png)
...
![](https://img.tbqa.cloud/gateway/dashboard/gateway-dashboard-rpc.png)
