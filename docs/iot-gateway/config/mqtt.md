...
![image](https://img.tbqa.cloud/gateway/mqtt-message-1.png)
{: refdef}

The device will be created and displayed in ThingsBoard based on the passed parameters.
{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/gateway/mqtt-created-device-1.png)
{: refdef}

{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/gateway/mqtt-created-device-2.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/gateway/mqtt-message-connect.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/gateway/mqtt-connect-device.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/gateway/mqtt-message-disconnect.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/gateway/mqtt-disconnect-device.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/gateway/mqtt-mosquitto-sub-wait-1.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/gateway/mqtt-update-attribute-1.png)
{: refdef}

Change firmware version value from "1.1" to "1.2". Then click "Update" button.

{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/gateway/mqtt-update-attribute-2.png)
{: refdef}

The firmware version has been updated to "1.2".

{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/gateway/mqtt-update-attribute-3.png)
{: refdef}

Broker received new message from the ThingsBoard server about updating attribute "FirmwareVersion" to "1.2".

{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/gateway/mqtt-mosquitto-sub-get-1.png)
{: refdef}
