...
![image](https://img.tbqa.cloud/gateway/gateway-modbus-attributes-1.png)
{: refdef}

{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-modbus-attributes-2.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-modbus-timeseries-1.png)
{: refdef}

{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-modbus-timeseries-2.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-modbus-attributeUpdates-1.png)
{: refdef}

For example, create a new attribute “maxTemperature” and give it a value “25”.

{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-modbus-attributeUpdates-2.png)
{: refdef}

{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-modbus-attributeUpdates-3.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-modbus-rpc-1.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-modbus-rpc-2.png)
{: refdef}
