...
![image](https://img.tbqa.cloud/gateway/opc-ua-simulation-server-1.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/opc-ua-configuration-1.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/opc-ua-simulation-server-2.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/opc-ua-configuration-2.png)
{: refdef}

After running **ThingsBoard IoT gateway**, you will see the new **Device OPC-UA** device in your ThingsBoard instance.

{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-opc-ua-attributes-1.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/opc-ua-simulation-server-3.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/opc-ua-configuration-3.png)
{: refdef}

You must see the attributes you sent to ThingsBoard in the **Attributes** section of your device.:

{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-opc-ua-attributes-2.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/opc-ua-simulation-server-4.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/opc-ua-configuration-4.png)
{: refdef}

You should be able to see the telemetry you have sent to ThingsBoard in the **Latest telemetry** section of your device:

{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-opc-ua-attributes-3.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-opc-ua-attributes-updates-2.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-opc-ua-attributes-updates-1.png)
{: refdef}
...
{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-opc-ua-attributes-updates-3.png)
{: refdef}

{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-opc-ua-attributes-updates-4.png)
{: refdef}

Now go to OPC UA server and make sure the value of the deviceName node is updated.

{:refdef: style="text-align: left;"}
![image](https://img.tbqa.cloud/gateway/gateway-opc-ua-attributes-updates-5.png)
{: refdef}
