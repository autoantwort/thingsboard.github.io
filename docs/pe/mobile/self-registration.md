...
self-registration:
 0:
  image: https://img.tbqa.cloud/mobile/pe/self-registration-1.png
  title: 'Check <b>Enable self registration from mobile application</b> checkbox'
 1:
  image: https://img.tbqa.cloud/mobile/pe/self-registration-2.png
