...
downlink-rule:
    0:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/downlink-rule-1-edge.png
    ...
    1:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/downlink-rule-2-edge.png
        title: 'Create an &#39;<b>integration downlink</b>&#39; node. Specify your integration in its settings;'
    2:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/downlink-rule-3-edge.png
...
assign-integration:
    0:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/assign-integration-1-edge.png
    ...
    1:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/assign-integration-2-edge.png
        title: 'Named <b>baseUrl</b> and set value as your Edge <b>IP:port</b>. After, click "Add" button;'
    2:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/assign-integration-3-edge.png
        title: 'Added the server attribute &#39;<b>&#39;baseUrl&#39;</b>&#39; to the edge;'
    3:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/assign-integration-4-edge.png
        title: 'Now, click "<b>Manage edge integrations</b>" icon of Edge entity;'
    4:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/assign-integration-5-edge.png
    ...
    5:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/assign-integration-6-edge.png
    ...
    6:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/assign-integration-7-edge.png
        title: 'In the "<b>Integration details</b>" window placeholder <b>${{baseUrl}}</b> will be replaced with the value of the attribute.'

send-uplink:
    0:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/send-uplink-1-edge.png
    ...
    1:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/send-uplink-2-edge.png
...
converter-events:
    0:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/converter-events-1-edge.png
    ...
    1:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/converter-events-2-edge.png
        title: 'To see the incoming message to the converter, click the three dots in the &#39;In&#39; column;'
    2:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/converter-events-3-edge.png
        title: 'To see the outgoing message from the converter, click the three dots in the &#39;Out&#39; column.'

send-again-message:
    0:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/downlink-responce-1-edge.png
        title: 'Send again the uplink message to HTTP integration;'
    1:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/downlink-responce-2-edge.png
        title: 'We will receive a response from the ThingsBoard in the terminal.'

downlink-converter-message:
    0:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/downlink-converter-message-1-edge.png
    ...
    1:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/downlink-converter-message-2-edge.png
        title: 'Click the three dots in the &#39;In&#39; column to see the message that came from the integration to the converter;'
    2:
        image: https://img.tbqa.cloud/pe/edge/integrations/http/downlink-converter-message-3-edge.png
...
![image](https://img.tbqa.cloud/pe/edge/integrations/http/add-http-integration-template-1-edge.png)
...
![image](https://img.tbqa.cloud/pe/edge/integrations/http/add-http-integration-template-4-edge.png)
...
![image](https://img.tbqa.cloud/pe/edge/integrations/http/add-shared-attribute-1-edge.png)

To make sure that downlink message sent to integration you can check "**Events**" tab of the integration:

![image](https://img.tbqa.cloud/pe/edge/integrations/http/downlink-message-1-edge.png)
