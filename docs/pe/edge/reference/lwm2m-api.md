...
started:
    0:
        image: https://img.tbqa.cloud/lwm2m/architecture.jpg 
        title: 'architecture LwM2M.'    
    1:
        image: https://img.tbqa.cloud/lwm2m/object_model.jpg 
        title: 'object model LwM2M.'       
    2:
        image: https://img.tbqa.cloud/lwm2m/procedure_client_initiated_bootstrap.jpg 
        title: 'procedure initiated client LwM2M.'    
    3:
        image: https://img.tbqa.cloud/lwm2m/client_registration.jpg 
        title: 'example client registration LwM2M.'    
    4:
        image: https://img.tbqa.cloud/lwm2m/relations_access_control_object_other_objects.jpg 
        title: 'access control object LwM2M.'

addResourcesModel_common:
    0:
        image: https://img.tbqa.cloud/lwm2m/resources_model_common_0.png 
        title: 'start import Resource -> object model LwM2M.'    
    1:
        image: https://img.tbqa.cloud/lwm2m/resources_model_common_1.png 
        title: 'click to select a file to upload.'       
    2:
        image: https://img.tbqa.cloud/lwm2m/resources_model_common_2.png 
        title: 'open file of Resource -> object model LwM2M (format xml).'    
    3:
        image: https://img.tbqa.cloud/lwm2m/resources_model_common_3.png 
        title: 'select the Resource type "LWM2M model" and add Resource -> object model LwM2M.'    
    4:
        image: https://img.tbqa.cloud/lwm2m/resources_model_common_4.png 
...
addResourcesModel_tenant:
    0:
        image: https://img.tbqa.cloud/lwm2m/resources_model_tenant_0.png 
        title: 'start import Resource -> object model LwM2M.'    
    1:
        image: https://img.tbqa.cloud/lwm2m/resources_model_common_1.png 
        title: 'click to select a file to upload.'       
...
profileNoSec_create:
    0:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_create_Step_1.png 
        title: 'start create profile LwM2M.'    
    1:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_create_Step_2.png 
        title: ' input the name of device profile (for example: "lwm2mProfileNoSec").'       
    2:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_create_Step_3.png 
        title: 'go to the "Transport configuration" tab and select the type of device profile.'    
    3:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_create_Step_4.png 
        title: 'save this device profile: click the "Add" button.'    


profileNoSec_edit:
    1:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_1.png 
        title: '<i>Select</i> line with the <b>name</b> of the <b>device profile</b> to change the configuration.'    
    2:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_2_3.png 
...
profileNoSec_edit_typeAfterConnect:      
    1:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_3_1.png 
        title: 'configuration: strategy number <b><font color="#5f9ea0">1</font> selected</b>.'    
    2:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_3_2.png 
        title: 'configuration: strategy number <b><font color="#5f9ea0">2</font> selected</b>.'       

profileNoSec_edit_add_object:      
    1:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_4_1.png 
        title: '<i>Select</i> an item <b>from</b> the list of <b>all the objects</b> ...'       
    2:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_4_2.png 
        title: '<i>Select</i> object <b>by ID object</b> (input only number ID).'    
    3:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_4_3.png 
        title: '<i>Select</i> object <b>by context</b> in the name object...'  

profileNoSec_edit_add_instance:
    1:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_4_4.png 
        title: '<i>Object</i> is supports <b>multiple instances</b>'    
    2:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_4_5.png
        title: '<b>Start</b> add...'    
    3:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_4_6.png
        title: '<b>Input</b> ID for new instance'     
    4:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_4_7.png
        title: '<b>Delete</b> ID instance'

profileNoSec_edit_observe:
    1:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_4_8.png 
    ...
    2:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_4_9.png 
    ...
    3:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_4_10.png 
    ...
    4:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_4_11.png 
...
profileNoSec_edit_bootstrap:      
    1:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_5_1.png 
    ...
    2:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_5_2.png 
    ...
    3:
        image: https://img.tbqa.cloud/lwm2m/noSec_profile_edit_Step_5_3.png 
...
deviceNoSec_create:
    0:
        image: https://img.tbqa.cloud/lwm2m/noSec_device_create_Step_1.png
    ...
    1:
        image: https://img.tbqa.cloud/lwm2m/noSec_device_create_Step_2.png
...
deviceNoSec_create_security_config:
    0:
        image: https://img.tbqa.cloud/lwm2m/noSec_device_create_security_Step_1.png
        title: '<b>- edit</b>: <b>"Client Security Config"</b>.'    
    1:
        image: https://img.tbqa.cloud/lwm2m/noSec_device_create_security_Step_2.png
        title: '<b>- edit</b>: <b>"Bootstrap Client"</b>: <font color="blue">BOOTSTRAP SERVER</font>.'       
    2:
        image: https://img.tbqa.cloud/lwm2m/noSec_device_create_security_Step_3.png
...
deviceNoSec_create_save:
    0:
        image: https://img.tbqa.cloud/lwm2m/noSec_device_create_Step_3.png
