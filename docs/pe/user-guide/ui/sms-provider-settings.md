...
smsProviderSettings:
    0:
        image: https://img.tbqa.cloud/user-guide/ui/sms/sms-provider-settings-step-2-pe.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/ui/sms/sms-provider-settings-step-3-pe.png
        title: 'If you have chosen AWS SNS, populate AWS Access Key ID and Secret access key. Click "Save" button;'
    2:
        image: https://img.tbqa.cloud/user-guide/ui/sms/sms-provider-settings-step-4-pe.png
    ...
    3:
        image: https://img.tbqa.cloud/user-guide/ui/sms/sms-provider-settings-step-5-pe.png
