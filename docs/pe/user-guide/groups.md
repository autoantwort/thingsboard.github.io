...
create-entity-group-2:
    0:
        image: https://img.tbqa.cloud/user-guide/entity-groups/create-entity-group-4-pe.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/entity-groups/create-entity-group-5-pe.png
    ...
    2:
        image: https://img.tbqa.cloud/user-guide/entity-groups/create-entity-group-6-pe.png
        title: 'The new device group is created.'

edit-entity-group-1:
    0:
        image: https://img.tbqa.cloud/user-guide/entity-groups/edit-entity-group-1-pe.png
        title: 'Click the "pencil" icon located in the group&#39;s row to open entity group details;'
    1:
        image: https://img.tbqa.cloud/user-guide/entity-groups/edit-entity-group-2-pe.png
        title: 'Then click on the "pencil" icon to enter edit mode;'
    2:
        image: https://img.tbqa.cloud/user-guide/entity-groups/edit-entity-group-3-pe.png
    ...
    3:
        image: https://img.tbqa.cloud/user-guide/entity-groups/edit-entity-group-4-pe.png
        title: 'Confirm firmware change for devices in this group;'
    4:
        image: https://img.tbqa.cloud/user-guide/entity-groups/edit-entity-group-5-pe.png
        title: 'You have updated entity group information.'

delete-entity-group-1:
    0:
        image: https://img.tbqa.cloud/user-guide/entity-groups/delete-entity-group-1-pe.png
        title: 'Click a "trash" icon can opposite the groups name you want to delete;'
    1:
        image: https://img.tbqa.cloud/user-guide/entity-groups/delete-entity-group-2-pe.png
        title: 'Confirm deleting the entity group in the dialog box.'

delete-entity-group-2:
    0:
        image: https://img.tbqa.cloud/user-guide/entity-groups/delete-entity-group-3-pe.png
        title: 'Click the "pencil" icon located in the group&#39;s row to open entity group details;'
    1:
        image: https://img.tbqa.cloud/user-guide/entity-groups/delete-entity-group-4-pe.png
        title: 'Click on the "Delete entity group" button in the entity group details;'
    2:
        image: https://img.tbqa.cloud/user-guide/entity-groups/delete-entity-group-5-pe.png
        title: 'Confirm deleting the entity group in the dialog box.'

delete-entity-group-3:
    0:
        image: https://img.tbqa.cloud/user-guide/entity-groups/delete-entity-group-6-pe.png
        title: 'Mark one or multiple groups you want to delete. Click on the trash bin icon in the top right corner;'
    1:
        image: https://img.tbqa.cloud/user-guide/entity-groups/delete-entity-group-7-pe.png
        title: 'Confirm deleting entity groups in the dialog box.'

column-configuration-add:
    0:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-1-pe.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-2-pe.png
        title: 'Click on the "pencil" icon to open entity group details;'
    2:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-3-pe.png
        title: 'Navigate to the "Columns" tab and click on the "pencil" icon to enter edit mode;'
    3:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-4-pe.png
        title: ' Then click on the "+ Add" button;'
    4:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-5-pe.png
    ...
    5:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-6-pe.png
        title: 'Input column name in the "title" row. Click "Save" and then apply all changes. We added new column - "Temperature";'
    6:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-7-pe.png
        title: 'It displays the current temperature value for each device.'

column-configuration-delete:
    0:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-8-pe.png
        title: 'In the device group click on the "pencil" icon to open entity group details;'
    1:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-9-pe.png
    ...
    2:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-10-pe.png
        title: 'After that, apply all changes;'
    3:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-10-1-pe.png
        title: 'The "Label" column is deleted from the device group.'

column-configuration-style function:
    0:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-11-pe.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-12-pe.png
    ...
    2:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-13-pe.png
...
column-configuration-content function:
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-14-pe.png
    ...
    2:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-15-pe.png
        title: 'The symbol "℃" is displayed after the device&#39;s temperature value.'

column-configuration-move:
    0:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-16-pe.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-17-pe.png
        title: 'After that, apply all changes;'
    2:
        image: https://img.tbqa.cloud/user-guide/entity-groups/column-configuration-18-pe.png
        title: 'The "Temperature" column is now located between the "Name" and "Device profile" columns.'

action-configuration:
    0:
        image: https://img.tbqa.cloud/user-guide/entity-groups/actions-tab-entity-group-1-pe.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/entity-groups/actions-tab-entity-group-2-pe.png
        title: 'Fill in all required fields in the pop-up window according to your task. Click "Add";'
    2:
        image: https://img.tbqa.cloud/user-guide/entity-groups/actions-tab-entity-group-3-pe.png
        title: 'We created new action. After that, apply all changes;'
    3:
        image: https://img.tbqa.cloud/user-guide/entity-groups/actions-tab-entity-group-4-pe.png
        title: 'A new icon appeared in the line of each of the devices, which is responsible for the created action. Click it;'
    4:
        image: https://img.tbqa.cloud/user-guide/entity-groups/actions-tab-entity-group-5-pe.png
        title: 'We will move to the dashboard with full information about thermometers.'

setting:
    0:
        image: https://img.tbqa.cloud/user-guide/entity-groups/settings-tab-entity-group-1-pe.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/entity-groups/settings-tab-entity-group-2-pe.png
        title: 'Now the "trash" icon is not in the device line;'
    2:
        image: https://img.tbqa.cloud/user-guide/entity-groups/settings-tab-entity-group-3-pe.png
        title: 'There is also no "Delete device" button in the device details.'

batch-operations:
    0:
        image: https://img.tbqa.cloud/user-guide/entity-groups/move-add-temove-from-entity-group.png
