...
server-side-rpc:
    0:
        image: https://img.tbqa.cloud/reference/device-connectivity-apis/server-side-rpc-coap-1-ce.png
        title: 'Use RPC debug terminal widget in your ThingsBoard instance'
    1:
        image: https://img.tbqa.cloud/reference/device-connectivity-apis/server-side-rpc-coap-2-ce.png
    ...
    2:
        image: https://img.tbqa.cloud/reference/device-connectivity-apis/server-side-rpc-coap-3-ce.png
        title: 'Send an RPC request "connect" to the device using RPC debug terminal widget'
    3:
        image: https://img.tbqa.cloud/reference/device-connectivity-apis/server-side-rpc-coap-4-ce.png
        title: 'In the second terminal window simulate send a response from the device to the server'
    4:
        image: https://img.tbqa.cloud/reference/device-connectivity-apis/server-side-rpc-coap-5-ce.png
...
client-side-rpc:
    ...
    3:
        image: https://img.tbqa.cloud/reference/device-connectivity-apis/client-side-rpc-coap-4-ce.png
        title: 'Send request to the server'
    4:
        image: https://img.tbqa.cloud/reference/device-connectivity-apis/client-side-rpc-coap-5-ce.png
