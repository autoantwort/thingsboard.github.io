...
![image](https://img.tbqa.cloud/reference/performance-tools/connect-publish-disconnect.png)
...
![image](https://img.tbqa.cloud/reference/performance-tools/connect-publish-publish-publish-disconnect.png)
...
![image](https://img.tbqa.cloud/reference/performance-tools/gatling-indicators.png)

![image](https://img.tbqa.cloud/reference/performance-tools/gatling-statistics.png)

![image](https://img.tbqa.cloud/reference/performance-tools/gatling-number-of-requests-per-second.png)

![image](https://img.tbqa.cloud/reference/performance-tools/gatling-number-of-responses-per-second.png)
