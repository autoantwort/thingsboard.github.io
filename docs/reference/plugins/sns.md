...
![image](https://img.tbqa.cloud/reference/plugins/sns/sns-plugin-config-1.png)

![image](https://img.tbqa.cloud/reference/plugins/sns/sns-plugin-config-2.png)
...
![image](https://img.tbqa.cloud/reference/plugins/sns/sns-activate-plugin.png)

### SNS Rule Configuration

In order to create SNS Rule, go to Rules screen and click 'Add New rule' button.

![image](https://img.tbqa.cloud/reference/plugins/sns/sns-rule.png)
...
![image](https://img.tbqa.cloud/reference/plugins/sns/sns-plugin-selection.png)

Add action that will send temperature telemetry of device to the particular SNS Topic:

![image](https://img.tbqa.cloud/reference/plugins/sns/sns-topic-action.png)

Click *'Add'* button and then activate Rule.

![image](https://img.tbqa.cloud/reference/plugins/sns/sns-activate-rule.png)
...
![image](https://img.tbqa.cloud/reference/plugins/sns/sns-create-subscription.png)
...
![image](https://img.tbqa.cloud/reference/plugins/sns/sns-email-delivery.png)