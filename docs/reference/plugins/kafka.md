...
![image](https://img.tbqa.cloud/reference/plugins/kafka/kafka-plugin-config-1.png)

![image](https://img.tbqa.cloud/reference/plugins/kafka/kafka-plugin-config-2.png)
...
![image](https://img.tbqa.cloud/reference/plugins/kafka/kafka-activate-plugin.png)

### Kafka Rule Configuration

Now it's time to create appropriate Rule.

![image](https://img.tbqa.cloud/reference/plugins/kafka/kafka-rule-config.png)
...
![image](https://img.tbqa.cloud/reference/plugins/kafka/kafka-plugin-selection.png)

Add action that will send temperature telemetry of device to particular kafka topic:

![image](https://img.tbqa.cloud/reference/plugins/kafka/send-temp-telemetry.png)
