...
![image](https://img.tbqa.cloud/reference/plugins/rest-api-call/rest-api-call-plugin-config-1.png)

![image](https://img.tbqa.cloud/reference/plugins/rest-api-call/rest-api-call-plugin-config-2.png)
...
![image](https://img.tbqa.cloud/reference/plugins/rest-api-call/rest-api-call-activate-plugin.png)

### REST API Call Rule Configuration

Now it's time to create appropriate Rule.

![image](https://img.tbqa.cloud/reference/plugins/rest-api-call/rest-api-call-rule-config.png)

Add filter for **POST_TELEMETRY** message type:

![image](https://img.tbqa.cloud/reference/plugins/rest-api-call/post-telemetry-filter.png)

Click *'Add'* button to add the filter.

Then select *'REST API Call Plugin'* in the drop-down box for the Plugin field:

![image](https://img.tbqa.cloud/reference/plugins/rest-api-call/rest-api-call-plugin-selection.png)
...
![image](https://img.tbqa.cloud/reference/plugins/rest-api-call/rest-api-call-rule-action-config-1.png)

![image](https://img.tbqa.cloud/reference/plugins/rest-api-call/rest-api-call-rule-action-config-2.png)
