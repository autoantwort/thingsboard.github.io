...
![image](https://img.tbqa.cloud/reference/performance/performance-diagram-0.svg)
...
![image](https://img.tbqa.cloud/reference/performance/performance-diagram-1.svg)
...
![image](https://img.tbqa.cloud/reference/performance/single_node_no_fix_stats.png) 
...
![image](https://img.tbqa.cloud/reference/performance/single_node_no_fix_rps.png) 
...
![image](https://img.tbqa.cloud/reference/performance/single_node_with_fix_stats.png)
 
![image](https://img.tbqa.cloud/reference/performance/single_node_with_fix_rps.png) 
...
![image](https://img.tbqa.cloud/reference/performance/single_node_x2_with_fix_stats.png)
...
![image](https://img.tbqa.cloud/reference/performance/single_node_x2_with_fix_time.png)

Number of requests per second was around 10K

![image](https://img.tbqa.cloud/reference/performance/single_node_x2_with_fix_rps.png)
...
![image](https://img.tbqa.cloud/reference/performance/performance-diagram-2.svg)
...
![image](https://img.tbqa.cloud/reference/performance/cluster_stats.png)
![image](https://img.tbqa.cloud/reference/performance/cluster_rps.png)
![image](https://img.tbqa.cloud/reference/performance/cluster_responses_ps.png)
