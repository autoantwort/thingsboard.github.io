...
deviceProfileConfiguration:
    0:
        image: https://img.tbqa.cloud/user-guide/device-provisioning/device-provisioning-step-1.png 
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/device-provisioning/device-provisioning-step-2.png 
    ...
    2:
        image: https://img.tbqa.cloud/user-guide/device-provisioning/device-provisioning-step-3.png 
