...
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-terminal-binary-uplink-message-1.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-terminal-binary-downlink-message-1.png)