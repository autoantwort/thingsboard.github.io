...
![image](https://img.tbqa.cloud/edge/overview/edge_overview.svg)
...
![image](https://img.tbqa.cloud/edge/overview/offline_network_.svg)
...
![image](https://img.tbqa.cloud/edge/overview/data_filtering.svg)

- **Local alarms**: Instantly respond to critical situations on site, without the need for a cloud connection.

![image](https://img.tbqa.cloud/edge/overview/alarm.svg)
...
![image](https://img.tbqa.cloud/edge/overview/update_dashboard.svg)
