...
![image](https://img.tbqa.cloud/user-guide/scheduler.svg)
...
![image](https://img.tbqa.cloud/user-guide/ui/scheduler.png)
...
![image](https://img.tbqa.cloud/user-guide/ui/scheduler-view-buttons.png)

In the calendar view mode scheduler events are presented as labels according to their schedule. 
  
![image](https://img.tbqa.cloud/user-guide/ui/scheduler-calendar-view.png)
...
![image](https://img.tbqa.cloud/user-guide/ui/scheduler-event-dialog.png)
...
![image](https://img.tbqa.cloud/user-guide/ui/scheduler-event-schedule.png)
...
![image](https://img.tbqa.cloud/user-guide/ui/scheduler-custom-event-type.png)
...
![image](https://img.tbqa.cloud/user-guide/ui/scheduler-generate-report-event-type-report-config.png)

![image](https://img.tbqa.cloud/user-guide/ui/scheduler-generate-report-event-type-email-config.png)
...
![image](https://img.tbqa.cloud/user-guide/ui/scheduler-update-attributes-event-type.png)
...
![image](https://img.tbqa.cloud/user-guide/ui/scheduler-send-rpc-request-event-type.png)
...
![image](https://img.tbqa.cloud/user-guide/ui/scheduler-scheduler-events-widget.png)
...
![image](https://img.tbqa.cloud/user-guide/ui/scheduler-scheduler-events-widget-custom-types.png)
