...
![Devices list](https://img.tbqa.cloud/user-guide/integrations/particle/particle-console-device-list.png)
...
![Login](https://img.tbqa.cloud/user-guide/integrations/particle/cli-login.png)
...
-  Create token with default expiration time (**90 days**) - 
   ...
   ```
   {:.copy-code}
![Login](https://img.tbqa.cloud/user-guide/integrations/particle/cli-token-created.png)
...
{% assign createIntegrationUsingWizard = '
   ===
      image: https://img.tbqa.cloud/user-guide/integrations/particle/tb-create-integration.png,
   ...
   ===
      image: https://img.tbqa.cloud/user-guide/integrations/particle/tb-select-uplink.png,
      title: Now, you can select the recently created **Uplink data Converter for Particle Integration**. Click **Next**.
   ===
      image: https://img.tbqa.cloud/user-guide/integrations/particle/tb-select-downlink.png,
      title: If you added a downlink converter, select it. Click **Next**.
   ===
      image: https://img.tbqa.cloud/user-guide/integrations/particle/tb-create-integration-configuration.png,
...
{% assign createParticleCloudIntegration = '
   ===
      image: https://img.tbqa.cloud/user-guide/integrations/particle/particle-console-integrations-2.png,
      title: Go to **Integrations** section and click "**Add new integration**" button.
   ===
      image: https://img.tbqa.cloud/user-guide/integrations/particle/particle-console-integrations-3.png,
      title: Click on the **Webhook**.
   ===
      image: https://img.tbqa.cloud/user-guide/integrations/particle/particle-console-integrations-4.png,
      title: Fill in all required fields. Then click **Create webhook**.
   ===
      image: https://img.tbqa.cloud/user-guide/integrations/particle/particle-console-integrations-5.png,
...
![image](https://img.tbqa.cloud/user-guide/integrations/particle/tb-new-device-created.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/particle/tb-create-downlink-rule-node.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/particle/tb-root-rule-chain.png)
...
![Particle WebIDE](https://img.tbqa.cloud/user-guide/integrations/particle/particle-webide-example.png)  
...
{% assign createParticleDashboard = '
   ===
      image: https://img.tbqa.cloud/user-guide/integrations/particle/particle-add-widget-1.png,
      title: Go to the "**Dashboards**" page, create a new dashboard and select "**Switch Control**" widget from the "**Control Widgets**" bundle.
   ===
      image: https://img.tbqa.cloud/user-guide/integrations/particle/particle-add-widget-2.png,
      title: Add new alias with previously created device. Then navigate to the "**Appearance**" tab.
   ===
      image: https://img.tbqa.cloud/user-guide/integrations/particle/particle-add-widget-3.png,
   ...
   ===
      image: https://img.tbqa.cloud/user-guide/integrations/particle/particle-add-widget-5.png,
