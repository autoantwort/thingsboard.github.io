...
Azure IoT Hub Integration allows to stream data from AWS IoT Backend to ThingsBoard and converts device payloads to the ThingsBoard format.
  ...
  <object width="80%" data="https://img.tbqa.cloud/user-guide/integrations/azure/iot-hub-integration.svg"></object>
...
![image](https://img.tbqa.cloud/user-guide/integrations/azure/iot-hub-converter.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/azure/iot-hub-add-integration.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/azure/iot-hub-send-test-msg.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/azure/iot-hub-validate-telemetry.png)
