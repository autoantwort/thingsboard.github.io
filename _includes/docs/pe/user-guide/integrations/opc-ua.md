...
![image](https://img.tbqa.cloud/user-guide/integrations/opc-ua/opc-ua-create-integration-1.png)

 - The next steps is to add the recently created uplink and downlink converters;

![image](https://img.tbqa.cloud/user-guide/integrations/opc-ua/opc-ua-create-integration-2.png)

![image](https://img.tbqa.cloud/user-guide/integrations/opc-ua/opc-ua-create-integration-3.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/opc-ua/opc-ua-create-integration-4.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/opc-ua/opc-ua-create-integration-5.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/opc-ua/opc-ua-devices-1.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/opc-ua/opc-ua-devices-2.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/opc-ua/opc-ua-dashboard-1.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/opc-ua/opc-ua-dashboard-2.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/opc-ua/opc-ua-dashboard-4.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/opc-ua/opc-ua-dashboard-5.png)
