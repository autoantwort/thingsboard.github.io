...
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-add-integration-1-pe.png)

- The next steps is to add the recently created **uplink** and **downlink** converters;

![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-add-integration-2-pe.png)

![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-add-integration-3-pe.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-add-integration-4-pe.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-add-integration-5-pe.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-add-integration-6-pe.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-send-uplink-message-1.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-go-to-devices-1-pe.png)

Here you will see information about the new device. As well as the telemetry which we sent to the device.

![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-go-to-devices-2-pe.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-go-to-devices-2.png)
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-events-1-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-events-1.png)
{% endif %}
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-converter-events-1-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-converter-events-1-paas.png)
{% endif %}
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-turn-knob-1-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-turn-knob-1.png)
{% endif %}
...
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-execute-command.png)
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-turn-the-wheel-1-pe.png)

![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-turn-the-wheel-2-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-turn-the-wheel-1.png)

![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-integration-turn-the-wheel-2.png)
{% endif %}
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-rpc-edit-integration-1-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-rpc-edit-integration-1.png)
{% endif %}
...
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-rpc-send-message-2.png)
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-rpc-turn-the-wheel-1-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-rpc-turn-the-wheel-1.png)
{% endif %}

Go to the **Devices** page and find *rpcReceived* telemetry value is "*OK*" on the **Latest telemetry** tab of your SN-001 device.

{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-rpc-device-1-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/mqtt/mqtt-rpc-device-1-paas.png)
{% endif %}
