...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-integration-setup-1-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-integration-setup-1-paas.png)
{% endif %}

- Add recently created TCP Uplink Converter;

{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-integration-setup-2-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-integration-setup-2-paas.png)
{% endif %}

- For now, leave the "Downlink Data Converter" field blank.

{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-integration-setup-3-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-integration-setup-3-paas.png)
{% endif %}
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-integration-setup-4-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-integration-setup-4-paas.png)
{% endif %}
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-integration-create-device-1-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-integration-create-device-1-paas.png)
{% endif %}
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-create-downlink-converter-tbel-1-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-create-downlink-converter-tbel-1-paas.png)
{% endif %}
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-edit-downlink-converter-tbel-1-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-edit-downlink-converter-tbel-1-paas.png)
{% endif %}
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-add-downlink-converter-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-add-downlink-converter-paas.png)
{% endif %}
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-rule-chain-downlink-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-rule-chain-downlink-paas.png)
{% endif %}
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-rule-chain-and-attributes-updated-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-rule-chain-and-attributes-updated-paas.png)
{% endif %}
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-create-shared-add-attribute-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-create-shared-add-attribute-paas.png)
{% endif %}
...
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-downlink-converter-events-in-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-downlink-converter-events-in-paas.png)
{% endif %}

The **“Out”** field displays messages to device:

{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-downlink-converter-events-out-pe.png)
{% endif %}
{% if docsPrefix == "paas/" %}
![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-downlink-converter-events-out-paas.png)
{% endif %}

An example of a sent message and a response from ThingsBoard in the terminal:

![image](https://img.tbqa.cloud/user-guide/integrations/tcp/tcp-terminal-send-downlink-message.png)
