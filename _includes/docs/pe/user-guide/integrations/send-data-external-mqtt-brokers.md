...
In this tutorial we will configure ThingsBoard Rule Engine to automatically send messages using MQTT
 ...
 Please review the integration diagram to learn more. 
  ...
  ![image](https://img.tbqa.cloud/user-guide/integrations/mqtt-integration.svg)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/mqtt-downlink-device.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/import_new_converter.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/mqtt-downlink-check-converters.png)

Uplink converter should look like this:

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/mqtt-downlink-uplink-converter.png) 

Downlink converter should look like this:

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/mqtt-downlink-downlink-converter.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/add-new-integration.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/mqtt-downlink-create-integration-1.png)
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/mqtt-downlink-create-integration-2.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/mqtt-downlink-work-demonstration.png) 
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/mqtt-downlink-root-rule-chain.png) 

  * **Node A**: Originator attributes enrichment node
      
    * Puts client attribute deviceName into metadata
    
   ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/mqtt-downlink-node-A.png) 
    
  * **Node B**: Script Transformation Node
      
     * Puts deviceName from metadata to message parameters
     
    ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/mqtt-downlink-node-B.png)

  * **Node C**: Integration Downlink node
  
    * Sends message to integration
    
    ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/tutorials/mqtt-downlink/mqtt-downlink-node-C.png) 
