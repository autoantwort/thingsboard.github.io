...
<object width="100%" style="max-width: max-content;" data="https://img.tbqa.cloud/user-guide/integrations/aws-iot-integration.svg"></object>
...
![image](https://img.tbqa.cloud/user-guide/integrations/aws-iot/aws-iot-add-integration-1-pe.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/aws-iot/aws-iot-add-integration-2-pe.png)

- For now, leave the "Downlink data converter" field blank.

![image](https://img.tbqa.cloud/user-guide/integrations/aws-iot/aws-iot-add-integration-3-pe.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/aws-iot/aws-iot-add-integration-4-pe.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/aws-iot/aws-iot-add-integration-5-pe.png)
