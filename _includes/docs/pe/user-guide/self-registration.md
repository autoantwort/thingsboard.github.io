...
![image](https://img.tbqa.cloud/user-guide/self-registration/reCAPTCHA.png)
...
![image](https://img.tbqa.cloud/user-guide/self-registration/digitalocean.png)
...
![image](https://img.tbqa.cloud/user-guide/self-registration/mailserver.png)
...
![image](https://img.tbqa.cloud/user-guide/self-registration/customer-admin-role.png)
...
![image](https://img.tbqa.cloud/user-guide/self-registration/read-only-role.png)
...
![image](https://img.tbqa.cloud/user-guide/self-registration/dashboard.gif)
...
![image](https://img.tbqa.cloud/user-guide/self-registration/dashboard-config.png)
...
![image](https://img.tbqa.cloud/user-guide/self-registration/action-config.png)
...
![image](https://img.tbqa.cloud/user-guide/self-registration/signup-form-config.png)
...
![image](https://img.tbqa.cloud/user-guide/self-registration/signup-form.png)
