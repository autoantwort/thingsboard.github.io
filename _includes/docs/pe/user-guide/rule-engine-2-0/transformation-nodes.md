...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/pe/nodes/transformation-duplicate-to-group.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/pe/nodes/transformation-duplicate-to-group-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/pe/nodes/transformation-duplicate-to-related.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/pe/nodes/transformation-duplicate-to-related-config.png)
