...
![image](https://img.tbqa.cloud/user-guide/reporting.svg)
...
![image](https://img.tbqa.cloud/user-guide/ui/reporting-export-dashboard-button.png)

- In the expanded drop-down menu, select the desired dashboard export option

![image](https://img.tbqa.cloud/user-guide/ui/reporting-export-dashboard-options.png)

- The report generation will start.

![image](https://img.tbqa.cloud/user-guide/ui/reporting-export-dashboard-progress.png)
...
![image](https://img.tbqa.cloud/user-guide/ui/reporting-pe-root-rule-chain-switch.png)
...
![image](https://img.tbqa.cloud/user-guide/ui/reporting-generate-report-rule-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/ui/reporting-reports-widget.png)
