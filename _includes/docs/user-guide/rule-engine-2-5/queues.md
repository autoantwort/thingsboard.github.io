...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/queues/add-queue-1-ce.png)
{% endif %}
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/queues/add-queue-1-pe.png)
{% endif %}

 - Enter queue name. Select the strategy type and configure retries processing settings and polling settings. Click Add.

{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/queues/add-queue-2-ce.png)
{% endif %}
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/queues/add-queue-2-pe.png)
{% endif %}

You have created a custom queue.

{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/queues/add-queue-3-ce.png)
{% endif %}
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/queues/add-queue-3-pe.png)
{% endif %}
