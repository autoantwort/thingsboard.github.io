...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/mail-settings-change-administrator-email-address-ce.png)
{% endif %}
{% if (docsPrefix == "pe/") or (docsPrefix == "paas/") %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/mail-settings-change-administrator-email-address-pe.png)
{% endif %}
...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/sendgrid-settings-ce.png)
{% endif %}
{% if (docsPrefix == "pe/") or (docsPrefix == "paas/") %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/sendgrid-settings-pe.png)
{% endif %}
...
![image](https://img.tbqa.cloud/user-guide/ui/mail/sendgrid-it-works.png)
...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/gmail-settings-basic-ce.png)
{% endif %}
{% if (docsPrefix == "pe/") or (docsPrefix == "paas/") %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/gmail-settings-basic-pe.png)
{% endif %}
...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/google-oauth-settings-1-ce.png)
{% endif %}
{% if (docsPrefix == "pe/") or (docsPrefix == "paas/") %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/google-oauth-settings-1-pe.png)
{% endif %}
...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/google-oauth-settings-2-ce.png)
{% endif %}
{% if (docsPrefix == "pe/") or (docsPrefix == "paas/") %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/google-oauth-settings-2-pe.png)
{% endif %}
...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/google-oauth-settings-3-ce.png)
{% endif %}
{% if (docsPrefix == "pe/") or (docsPrefix == "paas/") %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/google-oauth-settings-3-pe.png)
{% endif %}
...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/microsoft-azure-oauth-settings-1-ce.png)
{% endif %}
{% if (docsPrefix == "pe/") or (docsPrefix == "paas/") %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/microsoft-azure-oauth-settings-1-pe.png)
{% endif %}
...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/microsoft-azure-oauth-settings-2-ce.png)
{% endif %}
{% if (docsPrefix == "pe/") or (docsPrefix == "paas/") %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/microsoft-azure-oauth-settings-2-pe.png)
{% endif %}
...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/microsoft-azure-oauth-settings-3-ce.png)
{% endif %}
{% if (docsPrefix == "pe/") or (docsPrefix == "paas/") %}
![image](https://img.tbqa.cloud/user-guide/ui/mail/microsoft-azure-oauth-settings-3-pe.png)
{% endif %}
