...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/two-factor-authentication/two-factor-authentication-ce.png)
{% endif %}
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/two-factor-authentication/two-factor-authentication-pe.png)
{% endif %}
...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/two-factor-authentication/two-factor-authentication-sysadmin-ce.png)
{% endif %}
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/two-factor-authentication/two-factor-authentication-sysadmin-pe.png)
{% endif %}
