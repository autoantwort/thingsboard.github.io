...
There are several ways to get the Chat ID:
 ...
 - First of all, you need send some message to your Bot:
    ...
    - in the private chat; 
       ...
       ![image](https://img.tbqa.cloud/gateway/telegram-bot/private-msg-to-bot.png)    
    
    - in the group where your Bot was added as a member.
    
       ![image](https://img.tbqa.cloud/gateway/telegram-bot/msg-to-bot-in-chat.png)    
...
![image](https://img.tbqa.cloud/gateway/telegram-bot/first-option.png)

 - Second option:

![image](https://img.tbqa.cloud/gateway/telegram-bot/second-option.png)
...
![image](https://img.tbqa.cloud/gateway/telegram-bot/send-to-telegram-chain.png)

 - **Root Rule Chain:**

![image](https://img.tbqa.cloud/gateway/telegram-bot/root-rule-chain.png)
...
![image](https://img.tbqa.cloud/gateway/telegram-bot/transform-script.png)
...
![image](https://img.tbqa.cloud/gateway/telegram-bot/rest-api-telegram-node.png)
...
![image](https://img.tbqa.cloud/gateway/telegram-bot/copy-token.png)
...
![image](https://img.tbqa.cloud/gateway/telegram-bot/msg-received-first-way.png)


- second option: 

![image](https://img.tbqa.cloud/gateway/telegram-bot/msg-received-second-way.png)
