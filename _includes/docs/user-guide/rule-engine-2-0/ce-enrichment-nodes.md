...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-calculate-delta.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-calculate-delta-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-customer-attributes.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-customer-attributes-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-device-attributes.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-device-attributes-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-orignator-and-device-attributes-tell-failure.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-originator-attributes.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-originator-attributes-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-originator-fields.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-originator-fields-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-related-attributes.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-related-attributes-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-tenant-attributes.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-tenant-attributes-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-originator-telemetry.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-originator-telemetry-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-originator-telemetry-fetch-mode.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-originator-telemetry-patterns.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-originator-telemetry-order-by.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-tenant-details.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-tenant-details-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-customer-details.png)

Rule Node Adds fields from Customer details to the message body or metadata.

There is **Add selected details to the message metadata** checkbox in the Node configuration. If this checkbox selected, existing fields will be added to the message metadata instead of message data.

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/enrichment-customer-details-config.png)
