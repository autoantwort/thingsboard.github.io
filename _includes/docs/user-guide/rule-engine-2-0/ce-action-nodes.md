...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-create-alarm.png)
...
-  get alarm type using pattern with fields from message metadata:
    ...
    ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-create-alarm-config-from-msg.png)
  
Note: Since TB Version 2.4.3 the rule node has the ability to:

- filter propagation to parent entities by relation types:

    ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-create-alarm-propagate-list.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-create-alarm-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-clear-alarm.png)
...
Note: Since TB Version 2.3.0 the rule node has the ability to get alarm type using pattern with fields from message metadata:
   ...
   ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-clear-alarm-fetch-alarm-type-from-metadata.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-clear-alarm-config.png)
...
![Configuration example image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-delay-config.png)
...
![Rule chain example image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-delay-chain.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-generator.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-generator-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-log.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-log-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-rpc-call-reply.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-rpc-call-reply-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-rpc-call-request.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-rpc-call-request-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-save-attributes.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-save-attributes-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-save-timeseries.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-save-timeseries-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-save-timeseries-config-latest.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-save-to-custom-cassandra-table.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-save-to-custom-cassandra-table-name-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-save-to-custom-cassandra-table-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-assign-to-customer-node.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-assign-to-customer-node-configuration.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-unassign-from-customer-node.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-unassign-from-customer-node-configuration.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-create-relation.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-create-relation-node-configuration.png)
...
**Note:** Since TB Version 2.3 the rule node has the ability to:
 ...
 - remove current relations from the originator of the incoming message based on direction and type: 
    ...
    ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-create-relation-node-remove-relations.png)
 ...
 - change the originator of the incoming message to the selected entity and process outboud messages as messages from another entity: 
    ...
    ![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-create-relation-node-change-originator.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-delete-relation.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-delete-relation-node-configuration.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-delete-relation-node-new-functionality.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-gps-geofencing-event-node.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/filter-gps-geofencing-default-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/filter-gps-geofencing-polygon-config.png)           

- Circle
                  
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/filter-gps-geofencing-circle-config.png)       
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/action-gps-geofencing-event-node-duration-config.png)  
