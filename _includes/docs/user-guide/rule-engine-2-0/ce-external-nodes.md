...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-aws-sns.png)

Node publish messages to AWS SNS (Amazon Simple Notification Service).

Configuration:

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-aws-sns-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-aws-sqs.png)

Node publish messages to the AWS SQS (Amazon Simple Queue Service).

Configuration:

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-aws-sqs-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-kafka.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-kafka-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-mqtt.png)

Publish incoming message payload to the topic of the configured MQTT broker with QoS **AT_LEAST_ONCE**. 

Configuration:

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-mqtt-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-iot-hub.png)

Configuration:

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-iot-hub-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-rabbitmq.png)

Publish incoming message payload to the RabbitMQ.

Configuration:

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-rabbitmq-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-rest-api-call.png)

Invoke REST API calls to the external REST server.

Configuration:

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-rest-api-call-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-send-email.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-send-email-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-send-notification.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-send-notification-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-send-sms.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-twilio-sms.png)

Sends incoming message payload as SMS message via Twilio service.

Configuration:

![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-twilio-sms-config.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-send-to-slack.png)
...
![image](https://img.tbqa.cloud/user-guide/rule-engine-2-0/nodes/external-send-to-slack-config.png)
