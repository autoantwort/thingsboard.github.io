...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/create-new-widget-type.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/select-widget-type.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor-toolbar.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor-resources.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor-html.png)

Third **CSS** tab contains widget specific CSS style definitions. 

![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor-css.png)

#### JavaScript section

This section contains all widget related JavaScript code according to the [Widget API](#basic-widget-api).  

![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor-javascript.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor-settings-schema.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor-datakey-settings-schema.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor-latest-datakey-setting-schema.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor-widget-settings-selectors.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor-schema-example.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor-appearence-example.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/widget-editor-preview.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/broadcast-service-start.png) 
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/broadcast-service-finish.png) 
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/latest-values-widget-sample.png) 
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/timeseries-widget-sample.png) 
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/control-widget-sample.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/dashboard-toolbar-entity-aliases.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/add-rpc-device-alias.png)

 - Click "Add" and then "Save" in **Entity aliases**.
 - Click dashboard "+" button then click "Create new widget" button.

![image](https://img.tbqa.cloud/user-guide/contribution/widgets/dashboard-create-new-widget-button.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/control-widget-sample-response-one-way.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/control-widget-sample-settings.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/control-widget-sample-response-two-way.png)

  - stop **mqtt-js-rpc-from-server.sh** script.
 Click **Send RPC command** button. You should see the following response in the widget.

![image](https://img.tbqa.cloud/user-guide/contribution/widgets/control-widget-sample-response-timeout.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/alarm-widget-sample.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/static-widget-sample.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/count-subscription.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/attributes-telemetry-subscription.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/page-link-subscription.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/timeseries-subscrition.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/alarm-subscription.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/external-js-widget-sample.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/external-js-timeseries-widget-sample.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/add-js-module.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/add-static-widget.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/select-extensions-module-2.png)
...
![image](https://img.tbqa.cloud/user-guide/contribution/widgets/select-extensions-module-3.png)

Now, your component is used inside your widget. 

![image](https://img.tbqa.cloud/user-guide/contribution/widgets/select-extensions-module-4.png)
