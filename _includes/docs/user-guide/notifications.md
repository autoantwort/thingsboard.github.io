...
{% if docsPrefix == null %}
![image](https://img.tbqa.cloud/user-guide/notifications/notification-center-1-ce.png)
{% endif %}
{% if docsPrefix == "pe/" %}
![image](https://img.tbqa.cloud/user-guide/notifications/notification-center-1-pe.png)
{% endif %}
