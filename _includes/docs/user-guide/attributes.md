...
![image](https://img.tbqa.cloud/user-guide/server-side-attributes.svg)
{: refdef}
...
{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/user-guide/shared-attributes.svg)
{: refdef}
...
{:refdef: style="text-align: center;"}
![image](https://img.tbqa.cloud/user-guide/client-side-attributes.svg)
{: refdef}
...
![image](https://img.tbqa.cloud/user-guide/telemetry-service/rest-api.png)
