...
{% assign addGatewaySteps = '
    ...
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsstack/2-welcome-screen.png,
        title: Select the "**Register a gateway**".
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsstack/3-gateway-list.png,
        title: Press the "**Register gateway**" button.
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsstack/4-register-gateway.png,
        title: Put information about the gateway (gateway EUI) and click the "**Register gateway**" button.
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsstack/5-gateway-info.png,
...
{% assign addIntegrationSteps = '
    === 
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsstack/2-welcome-screen-application.png,
        title: Open your console and click on the "<b>Create an application</b>".
    === 
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsstack/3-create-application.png,
        title: Fill in the required fields about the application. Then click "**Create application**" button.
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsstack/5-generate-new-api-key.png,
        title: Open "<b>Integrations</b>" -> "<b>MQTT</b>" page in the left menu. Click on the "<b>Generate new API key</b>" button.
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsstack/6-copy-access-key.png,
...
{% assign createTTSIntegration = '
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsstack/1-create-tts-integration.png,
    ...
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsstack/2-create-tts-integration-uplink.png,
        title: Paste the previously copied script to the Decoder function section. Click “Next”.
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsstack/3-create-tts-integration-downlink.png,
        title: Leave the “Downlink data converter” field empty. Click on “Skip” button.
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsstack/4-create-tts-integration-configuration.png,
