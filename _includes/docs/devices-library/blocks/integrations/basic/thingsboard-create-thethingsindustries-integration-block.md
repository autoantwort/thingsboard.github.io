...
{% assign addIntegrationSteps = '
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsindustries/integration-mqtt-new-key.png,
    ...
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsindustries/integration-mqtt.png,
...
{% assign createTTIIntegration = '
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsindustries/1-create-tti-integration.png,
    ...
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsindustries/2-create-tti-integration-uplink.png,
        title: Paste the previously copied script to the Decoder function section. Click "**Next**".
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsindustries/3-create-tti-integration-downlink.png,
        title: Leave the "**Downlink data converter**" field empty. Click on "**Skip**" button.
    ===
        image: https://img.tbqa.cloud/devices-library/basic/integrations/thethingsindustries/4-create-tti-integration-configuration.png,
