...
{% assign libraryInstallation = '
    ===
        image: https://img.tbqa.cloud/devices-library/basic/arduino-ide/tools-manage-libraries.png
        title: Go to "**Tools**" tab and click on "**Manage libraries**".
    ===
        image: https://img.tbqa.cloud/devices-library/basic/arduino-ide/manage-libraries-thingsboard.png
...
{% assign mbedtlsInstallation='
    ===
        image: https://img.tbqa.cloud/devices-library/basic/arduino-ide/install-mbedtls.png,
...
{% assign oledInstallation='
    ===
        image: https://img.tbqa.cloud/devices-library/basic/arduino-ide/install-adafruit-ssd1306.png,
...
{% assign wifininaInstallation='
    ===
        image: https://img.tbqa.cloud/devices-library/basic/arduino-ide/install-wifinina.png,
