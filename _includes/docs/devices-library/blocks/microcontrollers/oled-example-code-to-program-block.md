...
{% assign codeByUploadButton='
    ===
        image: https://img.tbqa.cloud/devices-library/basic/arduino-ide/upload.png
' 
%}
...
{% assign codeByUploadWithProgrammer='
    ===
        image: https://img.tbqa.cloud/devices-library/basic/arduino-ide/select-esptool-programmer.png,
        title: Go to "Tools" > "Programmer" and select "Esptool" as a programmer.  
    ===
        image: https://img.tbqa.cloud/devices-library/basic/arduino-ide/upload-using-programmer.png,
