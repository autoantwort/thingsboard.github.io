...
{% assign updateLedBlinkingPeriod = '
    ...
    ===
        image: https://img.tbqa.cloud/devices-library/basic/microcontrollers/dashboard/thingsboard-example-dashboard-blinking-interval-change.png,
...
{% assign updateLedColor = '
    ===
        image: https://img.tbqa.cloud/devices-library/basic/microcontrollers/dashboard/thingsboard-example-dashboard-change-led-color.png,
...
{% assign updateTextOnDisplay = '
    ===
        image: https://img.tbqa.cloud/devices-library/basic/microcontrollers/dashboard/thingsboard-example-dashboard-update-oled-screen.png,
