...
{% if docsPrefix == null %}
<object width="100%" data="https://img.tbqa.cloud/reference/thingsboard-architecture.svg"></object>
{% endif %}
{% if (docsPrefix == "pe/") or (docsPrefix == "paas/") %}
<object width="100%" data="https://img.tbqa.cloud/reference/thingsboard-architecture-pe.svg"></object>
{% endif %}
