...
![image](https://img.tbqa.cloud/samples/analytics/kafka-streams/kafka-streams-example.svg)
...
![image](https://img.tbqa.cloud/user-guide/integrations/kafka/deviation.png)
...
![image](https://img.tbqa.cloud/samples/analytics/kafka-streams/solar-module-devices.png) 
...
![image](https://img.tbqa.cloud/samples/analytics/kafka-streams/add-kafka-rule-node.png)

Now, let's add "generator" node for the first module. We will configure generator to constantly "produce" 5 watts. 

![image](https://img.tbqa.cloud/samples/analytics/kafka-streams/add-module1-simulator-rule-node.png)
...
![image](https://img.tbqa.cloud/samples/analytics/kafka-streams/add-module3-simulator-rule-node.png)

The result rule chain should look similar to this one:

![image](https://img.tbqa.cloud/samples/analytics/kafka-streams/simulator-rule-chain.png)
...
![image](https://img.tbqa.cloud/samples/analytics/kafka-streams/check-no-errors.png)
...
![image](https://img.tbqa.cloud/user-guide/integrations/kafka/latex.png)
...
![image](https://img.tbqa.cloud/samples/analytics/kafka-streams/add-converter.png)

#### Configure Kafka Integration

Let's create kafka integration that will subscribe to “solar-module-anomalies” topic.

![image](https://img.tbqa.cloud/samples/analytics/kafka-streams/add-integration.png)
