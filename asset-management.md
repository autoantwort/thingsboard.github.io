...
<div id="header-block" class="block-wrapper wrapper-main-color">
    <div class="block-content">
        ...
        <img style="box-shadow: 0px 0px 40px 10px #00000014;" class="image" srcset="https://img.tbqa.cloud/iot-articles/asset-management_1_1090x658.png 1090w, https://img.tbqa.cloud/iot-articles/asset-management_1_2180x1316.png 2180w" sizes="(max-width: 1920px) 1090px, (min-width: 1921px) 2180px" src="https://img.tbqa.cloud/iot-articles/asset-management_1_1090x658.png" alt="IoT solutions dashboard with widgets dark"/>
        <div class="text-wrapper">
        ...
        <img class="image" srcset="https://img.tbqa.cloud/iot-articles/asset-management_2_1090x682.png 1090w, https://img.tbqa.cloud/iot-articles/asset-management_2_2180x1364.png 2180w" sizes="(max-width: 1920px) 1090px, (min-width: 1921px) 2180px" src="https://img.tbqa.cloud/iot-articles/asset-management_2_1090x682.png" alt="IoT solutions dashboard with widgets dark"/>
        <div class="text-wrapper">
