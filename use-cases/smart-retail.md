...
<div class="usecase-carousel owl-carousel owl-theme">
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/smart-retail/sr1.png" alt="smart retail 1">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/smart-retail/sr2.png" alt="smart retail 2">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/smart-retail/sr3.png" alt="smart retail 3">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/smart-retail/sr4.png" alt="smart retail 4">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/smart-retail/sr5.png" alt="smart retail 5">
    </div>
</div>
...
<object width="100%" style="max-width: max-content; margin: 32px 0" data="https://img.tbqa.cloud/iot-use-cases/common-edge.svg"></object>
