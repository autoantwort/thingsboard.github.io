...
<div class="usecase-carousel owl-carousel owl-theme">
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/water-metering/wm1.png" alt="water metering 1">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/water-metering/wm2.png" alt="water metering 2">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/water-metering/wm3.png" alt="water metering 3">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/water-metering/wm4.png" alt="water metering 4">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/water-metering/wm5.png" alt="water metering 5">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/water-metering/wm6.png" alt="water metering 6">
    </div>
</div>
...
<section class="usecase-advantages">
    ...
    <div class="cards row">
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/microservices-icon.svg" alt="Microservice icon">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/telemetry-icon.svg" alt="Telemetry icon">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/integration-icon.svg" alt="Integration icon">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/security-icon.svg" alt="Security icon">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/engine-icon.svg" alt="Gear icon">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/visualization-icon.svg" alt="Data visualization icon">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/device-icon.svg" alt="Device icon">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/tenancy-icon.svg" alt="Tenancy icon">
                <div>
...
<object width="100%" style="max-width: max-content; margin: 32px 0" data="https://img.tbqa.cloud/iot-use-cases/common.svg"></object>
