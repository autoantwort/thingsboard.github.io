...
<div class="usecase-carousel owl-carousel owl-theme">
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/solutions/waste_monitoring/waste-monitoring-1.png" alt="waste monitoring 1">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/solutions/waste_monitoring/waste-monitoring-2.png" alt="waste monitoring 2">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/solutions/waste_monitoring/waste-monitoring-3.png" alt="waste monitoring 3">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/solutions/waste_monitoring/waste-monitoring-4.png" alt="waste monitoring 4">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/solutions/waste_monitoring/waste-monitoring-5.png" alt="waste monitoring 5">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/solutions/waste_monitoring/waste-monitoring-6.png" alt="waste monitoring 6">
    </div>
</div>
...
<section class="usecase-advantages">
    ...
    <div class="cards row">
        <div class="col-lg-6">
            <div class="block">
                <object data="https://img.tbqa.cloud/microservices-icon.svg"></object>
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <object data="https://img.tbqa.cloud/telemetry-icon.svg"></object>
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <object data="https://img.tbqa.cloud/integration-icon.svg"></object>
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <object data="https://img.tbqa.cloud/security-icon.svg"></object>
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <object data="https://img.tbqa.cloud/engine-icon.svg"></object>
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <object data="https://img.tbqa.cloud/visualization-icon.svg"></object>
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <object data="https://img.tbqa.cloud/phone-icon.svg"></object>
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <object data="https://img.tbqa.cloud/tenancy-icon.svg"></object>
                <div>
...
<object width="100%" style="max-width: max-content; margin: 32px 0" data="https://img.tbqa.cloud/iot-use-cases/smart-energy-diagram.svg"></object>
