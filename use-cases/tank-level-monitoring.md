...
<div class="usecase-carousel owl-carousel owl-theme">
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/fuel-level-monitoring/fuel-monitoring-1.png" />
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/fuel-level-monitoring/fuel-monitoring-2.png" />
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/fuel-level-monitoring/fuel-monitoring-3.png" />
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/fuel-level-monitoring/fuel-monitoring-4.png" />
    </div>
</div>
...
<section class="usecase-advantages">
    ...
    <div class="cards row">
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/microservices-icon.svg">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/telemetry-icon.svg">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/integration-icon.svg">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/security-icon.svg">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/engine-icon.svg">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/visualization-icon.svg">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/device-icon.svg">
                <div>
        ...
        <div class="col-lg-6">
            <div class="block">
                <img src="https://img.tbqa.cloud/tenancy-icon.svg">
                <div>
