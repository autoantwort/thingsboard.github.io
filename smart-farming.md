...
<div class="usecase-carousel owl-carousel owl-theme">
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/smart-farming/sf1.png" alt="Smart farming dashboard with location">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/smart-farming/sf2.png" alt="Smart farming dashboard with big linear chart">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/smart-farming/sf3.png" alt="Smart farming dashboard dark theme">
    </div>
</div>
...
<object width="100%" style="max-width: max-content; margin: 32px 0" data="https://img.tbqa.cloud/iot-use-cases/smart-farming.svg"></object>
