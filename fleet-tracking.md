...
<div class="center">
    <img src="https://img.tbqa.cloud/solution-templates/fleet-tracking.png">
</div>
<br>
...
<div class="usecase-carousel owl-carousel owl-theme">
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/fleet-tracking/ft1.png" alt="Bus locations example">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/fleet-tracking/ft2.png" alt="Route history example">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/fleet-tracking/ft3.png" alt="Route area example">
    </div>
</div>
...
<object width="100%" style="max-width: max-content; margin: 32px 0" data="https://img.tbqa.cloud/iot-use-cases/fleet-tracking.svg"></object>
