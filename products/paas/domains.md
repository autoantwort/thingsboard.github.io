...
registerDomain:
    0:
        image: https://img.tbqa.cloud/user-guide/domain/domain-register-step-1.png
        title: 'Go to the "Settings" page, then navigate to the "Domain" tab. On the "Domain" tab click on the "Register domain" button;'
    1:
        image: https://img.tbqa.cloud/user-guide/domain/domain-register-step-2.png
        title: 'Enter valid domain name in the input field and click on the "Register" button;'
    2:
        image: https://img.tbqa.cloud/user-guide/domain/domain-register-step-3.png
        title: 'You will be prompted a reminder about the CNAME;'
    3:
        image: https://img.tbqa.cloud/user-guide/domain/domain-register-step-4.png
    ...
    4:
        image: https://img.tbqa.cloud/user-guide/domain/domain-register-step-5.png
        title: 'If succeeded, you will see your domain name on the "Domain" tab.'

white-labeling:
    0:
        image: https://img.tbqa.cloud/user-guide/domain/domain-white-labeling-1.png
    ...
    1:
        image: https://img.tbqa.cloud/user-guide/domain/domain-login-1.png
...
domainDetails:
    0:
        image: https://img.tbqa.cloud/user-guide/domain/domain-details-step-1.png
        title: 'To view a registered domain details click "Domain details" button on the "Domain" tab;'
    1:
        image: https://img.tbqa.cloud/user-guide/domain/domain-details-step-2.png
...
deleteDomain:
    0:
        image: https://img.tbqa.cloud/user-guide/domain/domain-delete-step-1.png
        title: 'To delete a registered domain click "Delete" button on the "Domain" tab;'
    1:
        image: https://img.tbqa.cloud/user-guide/domain/domain-delete-step-2.png
