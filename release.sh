...
do
  ...
  find . -type f -iname "$ext" -exec sed -i -e '/https/! s/\/images\//https:\/\/img.tbqa.cloud\//g' {} \;
  find . -type f -iname "$ext" -exec sed -i -e 's/https:\/\/thingsboard.io\/images\//https:\/\/img.tbqa.cloud\//g' {} \;
  find . -type f -iname "$ext" -exec sed -i -e '/https:\/\/img.tbqa.cloud\/partners\/map-of-distributors\.svg/ s/https:\/\/img.tbqa.cloud\/partners\/map-of-distributors\.svg/\/images\/partners\/map-of-distributors.svg/g' {} \;
done
