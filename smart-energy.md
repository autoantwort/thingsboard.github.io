...
<div class="center">
    <img src="https://img.tbqa.cloud/iot-articles/energy_management_1_1110x678.png"/>
</div>
...
<div class="usecase-carousel owl-carousel owl-theme">
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/smart-energy/se1.png" alt="Smart energy monitoring light theme exmple with the pie chart">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/smart-energy/se2.png" alt="Smart energy monitoring dark theme exmple without the pie chart">
    </div>
    <div>
        <img class="item-image" src="https://img.tbqa.cloud/usecases/smart-energy/se3.png" alt="Smart energy monitoring dark theme exmple">
    </div>
</div>
