...
<div id="header-block" class="block-wrapper wrapper-main-color">
    <div class="block-content">
        ...
        <img class="image" srcset="https://img.tbqa.cloud/iot-articles/device_management_1_1090x672.png 1090w, https://img.tbqa.cloud/iot-articles/device_management_1_2180x1344.png 2180w" sizes="(max-width: 1920px) 1090px, (min-width: 1921px) 2180px" src="https://img.tbqa.cloud/iot-articles/device_management_1_1090x672.png" alt="IoT solutions dashboard with widgets dark"/>
        <div class="text-wrapper">
...
<div class="block-wrapper wrapper-main-color medium-padding">
    <div class="block-content">
        ...
        <img class="image" srcset="https://img.tbqa.cloud/iot-articles/device_settings_1_1090x658.png 1090w, https://img.tbqa.cloud/iot-articles/device_settings_1_2180x1316.png 2180w" sizes="(max-width: 1920px) 1090px, (min-width: 1921px) 2180px" src="https://img.tbqa.cloud/iot-articles/device_settings_1_1090x658.png" alt="IoT solutions dashboard with widgets dark"/>
        <div class="text-wrapper">
